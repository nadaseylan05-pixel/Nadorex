...
function ImageGallery({ product, variant }) {

    /*
     * =========================================================
     * الصور التي سيتم عرضها
     *
     * إذا لم توجد نسخة مختارة:
     * → نعرض صور المنتج الأساسي
     *
     * إذا توجد نسخة مختارة:
     * → نعرض صور هذه النسخة فقط
     * =========================================================
     */
    ...
    const images = useMemo(() => {
        ...
        if (variant) {
            ...
            // إذا كانت النسخة تحتوي على صورة مباشرة
            else {
    ...
    // =========================================================
    // عند تغيير النسخة
    // نبدأ دائمًا من أول صورة للنسخة الجديدة
    // =========================================================
